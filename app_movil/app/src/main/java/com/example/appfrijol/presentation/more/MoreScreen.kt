    ...
    Box(
        ...
        Column(
            ...
            Card(
                ...
                Row(
                    ...
                    Icon(Icons.Default.School, contentDescription = "Capacitación", tint = MaterialTheme.colorScheme.primary)
                    Spacer(modifier = Modifier.width(16.dp))
            ...
            Card(
                ...
                Row(
                    ...
                    Icon(Icons.Default.SupportAgent, contentDescription = "Contacto", tint = MaterialTheme.colorScheme.primary)
                    Spacer(modifier = Modifier.width(16.dp))
        ...
        if (showSupportDialog) {
            AlertDialog(
                ...
                text = {
                    Column {
                        Text("Teléfono: +591 71234567")
                        Text("Correo: soporte@miapp.com")
                    }
                },
                confirmButton = {
